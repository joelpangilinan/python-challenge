...
# Print the results to the analysis folder and name the file as analysis_report.txt
analysis_path = os.path.join("C:/Users/Joel/Documents/UC-Berkeley-Boot-Camp/Weekly-assignments/module3/Starter_Code/Instructions/python-challenge/PyBank", "analysis", "analysis.txt")
with open(analysis_path, 'w') as analysis_file:
    analysis_file.write("Financial Analysis")
    analysis_file.write("-------------------------------------------------------")
    # analysis_file.write("Total Months: ", total_months)
    analysis_file.write(str(print("Total Months: ", number_of_months - 1)))
